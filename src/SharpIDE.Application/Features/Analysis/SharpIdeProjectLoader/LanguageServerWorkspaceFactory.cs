...
internal sealed class LanguageServerWorkspaceFactory
{
        ...
        ILoggerFactory loggerFactory)
    {
        ...
        var workspace = new LanguageServerWorkspace(hostServices, WorkspaceKind.Host);
        ...
        var miscellaneousFilesWorkspace = new LanguageServerWorkspace(hostServices, WorkspaceKind.MiscellaneousFiles);
