...
public static partial class ThemeGenerator
{
    ...
    {
        LowContrastBackground = new Color(0.1f, 0.1f, 0.1f, 0.105882354f),
        MediumContrastBackground = new Color(0.22f, 0.22f, 0.22f, 0.21568628f),
        LowContrastBorder = new Color(0f, 0f, 0f, 0.101960786f),
        HighContrastBackground = new Color(0f, 0f, 0f, 0.1254902f),
        ...
        ButtonPressedBackground = new Color(0f, 0f, 0f, 0.3372549f),
        CodeEditBackground = new Color(0.98f, 0.98f, 0.98f, 1f),
        SidebarHoverBackground = new Color(0f, 0f, 0f, 0.05882353f),
        LineEditBackground = new Color(0.1f, 0.1f, 0.1f, 0.105882354f),
        NavigationNormalBackground = new Color(0.1f, 0.1f, 0.1f, 0.6f),
        ...
        TreeCursorBackground = new Color(0f, 0f, 0f, 0.32156864f),
        TreeCursorBorder = new Color(0f, 0f, 0f, 0.5686275f),
        ScrollbarGrabberHighlight = new Color(0f, 0f, 0f, 0.2509804f),
        ScrollbarGrabberPressed = new Color(0f, 0f, 0f, 0.1882353f),
        WindowBackground = new Color(0.98f, 0.98f, 0.98f, 1f),
        WindowUnfocusedBackground = new Color(0.94f, 0.94f, 0.94f, 1f),
    ...
    {
        public Color LowContrastBackground { get; init; } = new(1f, 1f, 1f, 0.030000001f);
        public Color MediumContrastBackground { get; init; } = new(1f, 1f, 1f, 0.0627451f);
        public Color LowContrastBorder { get; init; } = new(1f, 1f, 1f, 0.101960786f);
        public Color HighContrastBackground { get; init; } = new(1f, 1f, 1f, 0.1254902f);
        ...
        public Color ButtonPressedBackground { get; init; } = new(0f, 0f, 0f, 0.19607843f);
        ...
        public Color WindowBackground { get; init; } = new(0.14767182f, 0.14767182f, 0.14767176f, 1f);
        public Color WindowUnfocusedBackground { get; init; } = new(0.10747979f, 0.107479714f, 0.10747973f, 1f);
